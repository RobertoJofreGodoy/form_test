...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post assessments_url, params: { assessment: { inhabited: @assessment.inhabited, location: @assessment.location, number: @assessment.number } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { inhabited: @assessment.inhabited, location: @assessment.location, number: @assessment.number } }
